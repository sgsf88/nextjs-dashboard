      ...
      <div className="flex flex-grow gap-4 sm:flex-col">
        ...
        <div className="flex flex-col bg-[#f9fafb] w-2/5 rounded-lg p-[80px] justify-center items-start gap-6 sm:w-full sm:px-[24px] sm:py-[40px]">
          <p className={`${montserrat.className} text-[30px] sm:text-[20px]`}>
            ...
            <a href="https://nextjs.org/learn/" target="_blank" className='text-point-color2 font-bold'>
              Next.js Learn Course
            </a>
            , brought to you by Vercel.
          </p>
          <Link href="/login" className="h-[48px] text-white flex items-center bg-point-color2 p-[24px] rounded-lg gap-[20px]">
            Log in
        ...
        <div className="w-3/5 px-[112px] py-[48px] flex items-center justify-center sm:w-full sm:p-[24px]">
          <Image
            ...
            height={760}
            placeholder="blur"
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mO89B0AAqEBy8wrNtcAAAAASUVORK5CYII="
            className="sm:hidden"
          />
          <Image
            src="/hero-mobile.png"
